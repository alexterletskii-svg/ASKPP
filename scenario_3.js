...
(function initScenarioEngine() {
    ...
    function finishScenario() {
        tooltip.style.display = 'none';
        activeTarget = null;
        showCustomAlert('<b>Сценарий #3 успешно завершён!</b><br><br>Вы научились загружать рулон, детально фильтровать метки по подклассам и проверять их. Точно таким же образом вы можете детализировать <b>абсолютно все классы дефектов</b>, чтобы сократить объём ненужной визуальной информации.');
    }
