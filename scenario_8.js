        ...
        // --- 5. ВЫКЛЮЧЕНО / ВОССТАНОВЛЕНИЕ ---
        {
            ...
            text: () => {
                ...
                if (el && el.classList.contains('inactive')) {
                    ...
                    return `Группа успешно активирована.<br><br>Кликните по ней ещё раз для перехода к следующему шагу.`;
                }
            },
            validate: (e) => {
                const el = e.target.closest('.filter-block');
