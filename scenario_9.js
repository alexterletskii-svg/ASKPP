...
(function initScenarioEngine() {
    ...
    const steps = [
        ...
        // --- 3. КОНЦЕПЦИЯ И ВКЛЮЧЕНИЕ "Ч.ДЕФЕКТЫ" ---
        {
            ...
            Натажмите на кнопку <span class="action-badge">Ч.дефекты</span> в нижней панели.<br><br>Обратите внимание: при ее включении красные полосы распадаются на маленькие крестики (+).`,
        ...
        // --- 4. ИЗУЧЕНИЕ ОТКРЫВШИХСЯ ДЕФЕКТОВ НА КАРТЕ ---
        {
            ...
            <div class="purpose-text">
                Крупные объекты разбились на мельчайшие базовые точки (+), что дает возможность изучить их по одному.
            </div>
