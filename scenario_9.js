...
(function initScenarioEngine() {
    ...
    const steps = [
        // --- 1. ВЫБОР РУЛОНА ---
        {
            ...
            eventType: 'click',
            placement: 'right',
            text: 'Добро пожаловать в обучение!<br><br>Сегодня мы разберем продвинутый метод анализа — инструмент детализации составных дефектов.<br><br>Для начала загрузите данные — кликните по <span class="action-badge">ЛЮБОМУ</span> рулону в левой таблице.',
