...
(function initScenarioEngine() {
    ...
    function finishScenario() {
        tooltip.style.display = 'none';
        activeTarget = null;
        showCustomAlert('<b>Сценарий #4 успешно завершен!</b><br><br>Теперь вы умеете переключаться между мгновенной осведомленностью (Ярлык), планированием вырезок по физическим габаритам (Реальный) и аналитическими данными (Таблица).');
    }
