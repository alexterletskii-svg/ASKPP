        ...
        // --- 6. КЛИКИ ПО СТРОКАМ В РЕЖИМЕ "ТАБЛИЦА" ---
{
    ...
    <b>Таблица содержит все ключевые данные о рулонах:</b> внутренний идентификатор, номер рулона системы 2-го уровня или ССМ, статус обработки, номера плавки, партии и рулона, название материала или покрытия, габариты рулона (толщина, длина, ширина), дата начала и окончания обработки, количество зафиксированных дефектов. Поиск нужного рулона можно производить в таблице, используя номера или время обработки, но удобнее и быстрее это делать через отдельный диалог поиска рулона.<br><br>
    <div class="purpose-text">
