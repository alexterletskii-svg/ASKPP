...
(function initScenarioEngine() {
    ...
    function finishScenario() {
        tooltip.style.display = 'none';
        activeTarget = null;
        showCustomAlert('<b>Сценарий #4 успешно завершен!</b><br><br>Вы научились управлять фильтрами камер:<br>• Отключать все камеры<br>• Включать отдельные камеры<br>• Включать целые группы камер (Верх/Низ)<br><br>Это позволяет быстро анализировать дефекты с конкретных камер или сторон рулона.');
    }
